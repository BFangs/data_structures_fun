...
#     print timeit("s.push(1); s.pop()", "from stack import Stack; s=Stack(range(50000))")

#     print "Time for native Python list as stack"
#     print timeit("s.append(1); s.pop()", "s=range(50000)")

#     print "Time for native Python deque as stack"
#     print timeit("s.append(1); s.pop()", "from collections import deque; s=deque(range(50000))")
